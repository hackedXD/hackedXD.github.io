...
var faudio = new Audio('xperror.mp3')
...
function openWindow(url) {
	aWindow = window.open(url, "_blank", 'menubar=no, status=no, toolbar=no, resizable=no, width=480, height=360, titlebar=no, alwaysRaised=yes');
}
